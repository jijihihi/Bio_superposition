        ...
        for batch in pbar:
            ...
            for i in range(0, x_cpu.size(0), enc_bs):
                ...
                with torch.no_grad():
                    ...
                    ##L2 정규화 해서 양 정규화해준다. amount normalization.
...
class Trainer:
    ...
    def train_epoch(self, epoch: int):
        ...
        for batch in pbar:
            ...
            pbar.set_postfix({"lr": f"{lr:.2e}", "loss": f"{cur:.4f}", "xbm_used": int(use_xbm)})
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.args.epochs + 1):
            ...
            # --- Linear probe early-stopping metric ---
            ...
            # early stopping based on LP accuracy
...
def get_args():
    ...
    p.add_argument("--save_dir", type=str, default="/content/drive/MyDrive/Final_paper/Model_MoCoXBM_PlateLP_LRRK2_L2 norm_hidden2048_resume_bias=True")
