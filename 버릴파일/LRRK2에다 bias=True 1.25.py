...
class Trainer:
    ...
    def train_epoch(self, epoch: int):
        ...
        for batch in pbar:
            ...
            pbar.set_postfix(
                {"lr": f"{lr:.2e}", "loss": f"{cur:.4f}", "xbm_used": int(use_xbm)}
            )
...
def get_args():
    ...
    p.add_argument(
        "--save_dir",
        type=str,
        default="/content/drive/MyDrive/Final_paper/Model_MoCoXBM_PlateLP_LRRK2_L2 norm_hidden2048_resume_bias=True",
    )
