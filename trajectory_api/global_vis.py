...
def plot_global_phate(
    ...
    fig.savefig(png_path.replace(".png", ".svg"), format="svg", bbox_inches="tight", facecolor="white", edgecolor="none")
    plt.close(fig)
...
def plot_global_paga(
    ...
    sc.pp.neighbors(adata_paga, n_neighbors=n_neighbors, n_pcs=n_pcs_actual if n_pcs_actual > 0 else 0)
