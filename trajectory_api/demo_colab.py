...
from trajectory_api import (load_and_preprocess, plot_feature_trends,
                            plot_global_paga, plot_global_phate,
...
for mut in mutations:
    ...
    adata_pair = run_pairwise_trajectory(
        adata=adata, mutation=mut, out_dir=OUT_DIR, prefix="log_std"
    )
    ...
    if adata_pair is not None:
        ...
        plot_trajectory_statistics(
            adata_pair, mutation=mut, out_dir=OUT_DIR, prefix="log_std"
        )
