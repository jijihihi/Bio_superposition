...
def compute_LV(
    original_gray: np.ndarray, filtered_gray: np.ndarray, window_size: int = 6
) -> float:
    """
...
def compute_HFE(
    original_gray: np.ndarray, filtered_gray: np.ndarray, radius: int = 6
) -> float:
    """
...
def compute_ESSIM(
    original_gray: np.ndarray, filtered_gray: np.ndarray, ksize: int = 5
) -> float:
    """
