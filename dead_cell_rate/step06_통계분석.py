...
def main():
    ...
    print("\n" + "=" * 80)
    print(f"{'Class':<12} {'N':>8} {'Mean':>12} {'Std':>12} {'CV(%)':>12} {'Min':>12} {'Max':>12}")
    print("-" * 80)
    ...
    for cls in ['Control', 'GBA', 'LRRK2', 'SNCA']:
        ...
        print(f"{cls:<12} {len(rates):>8} {mean:>12.6f} {std:>12.6f} {cv:>12.2f} {rates.min():>12.6f} {rates.max():>12.6f}")
    ...
    for cls in ['Control', 'GBA', 'LRRK2', 'SNCA']:
        ...
        print(f"{cls:<12} | Pooled: {pooled_rate:.6f} | Per-Image Mean: {per_image_mean:.6f} | Ratio: {pooled_rate/per_image_mean if per_image_mean > 0 else 0:.2f}x")
