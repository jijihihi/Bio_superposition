...
def get_args():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default=r"./Output/patches/Rejected_cropped_image",
        help="Directory to move REJECTED patches to.",
    )

    # [0] Channel standard deviation sum
    parser.add_argument(
        "--min_std_sum",
        type=float,
        default=3500.0,
    ...
    # [3] Background filtering setup (Fiji Style Linear Scaling)
    # Top n% (for Max Cutoff)
    parser.add_argument(
    ...
    # Bottom n% (for Min Cutoff - background removal criterion)
    parser.add_argument(
...
def check_quality_combined(img, args):
    ...
    # Step 0: Channel Std Sum Check (Filter out background-heavy images)
