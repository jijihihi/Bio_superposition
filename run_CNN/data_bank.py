...
class InMemorySixteenBitDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        # Function to apply random or explicit augmentation
        def apply_aug(img_tensor, is_second_crop=False):
            if self.explicit_4x_augment and not is_second_crop:
        ...
        if self.two_crops:
            v1 = apply_aug(x.clone(), is_second_crop=False)
            v2 = apply_aug(x.clone(), is_second_crop=True)
